...
% Additional modifications by Alison King 2012.05.02
% Bruker2MEIDali.m
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Assumptions:
...
directory = C:\Users\Dunnlab\Downloads\m09096-tom-01.h81.zip\7\;
...
s = strfind( directory, '\' ); %NOTE, needs to be different for mac
MEID.filename = directory( s(end-2) + 1 : s(end) -1 );
